...
4. **Google review count is NOT on the page** — only "Rated 5.0 on Google" (what his own site claims). Matt is getting the count; when it's verified, add "across N Google reviews" to the `.gbar` strip and the reviews banner on both pages.
...
- Claims on the page are sourced: TCEQ #25629, liability insured, family owned since 2019, 5.0 on Google, the five reviews verbatim — all from his live site / his answers. Don't add a review count, "24/7", guarantees, or years-of-experience beyond 2019.
